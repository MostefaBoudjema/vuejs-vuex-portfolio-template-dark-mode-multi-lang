						...
						<div
							...
							<div class="modal-body p-5 w-full h-full">
								<form class="max-w-xl m-4 text-left">
									<FormInput :label="$t('Full Name')" inputIdentifier="name" class="mb-2" />
									<FormInput :label="$t('Email')" inputIdentifier="email" inputType="email" />

									<div class="mt-6 mb-4">
										<label class="block mb-2 text-lg text-primary-dark dark:text-primary-light"
											for="project">
											{{ $t('Project Type') }}
										</label>
										<select
									...
									<FormTextarea :label="$t('Details')" textareaIdentifier="details" />

									<div class="mt-7 pb-4 sm:pb-1">
										<Button :title="$t('Send Request')"
...
const categories=ref(settingsData.categories);
