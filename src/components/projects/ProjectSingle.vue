...
<template>
    <div v-if="!project.hide">
        ...
        <div class="text-center px-4 py-6 d-flex justify-content-center align-items-center">
            ...
            <a class="text-lg text-center text-link d-flex" v-if="project.projectInfo.companyInfos[2].details != '#'"
                :href="project.projectInfo.companyInfos[2].details" target="_blank">
                <!-- {{ t("Check it") }} -->

                <i data-feather="external-link" id="my-link" class="" stroke-width="3"></i>
            </a>
